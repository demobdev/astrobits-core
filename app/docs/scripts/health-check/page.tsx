...
import { CheckCircle, Clock, FileText, Settings } from "lucide-react"

export default function MCPHealthCheckPage() {
  return (
    <DocsLayout
      title="MCP Health Check - Health check scripts and tools"
      breadcrumbs={[{"title":"Home","href":"/"},{"title":"Documentation","href":"/docs"},{"title":"Health-check","href":"/docs/health-check"},{"title":"MCP Health Check","href":"/docs/scripts/health-check/page"}]}
    >
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl sm:text-2xl mb-8 text-muted-foreground max-w-4xl mx-auto">
            Health check scripts and tools
          </p>
        </div>
        ...
        <Card className="mb-16 border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
          <CardHeader className="text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Comprehensive documentation for MCP Health Check is being prepared.
            </p>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3 text-center">
              <div>
                <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <CheckCircle className="size-8 text-blue-600 dark:text-blue-400" />
                </div>
                <h3 className="text-lg font-semibold mb-2">MCP Health Check</h3>
                <p className="text-muted-foreground">Health check scripts and tools</p>
              </div>
              <div>
