...
export default function SetupScriptsPage() {
  return (
    <DocsLayout
      title="Setup Scripts - Project setup and configuration scripts"
      breadcrumbs={[{"title":"Home","href":"/"},{"title":"Documentation","href":"/docs"},{"title":"Setup","href":"/docs/setup"},{"title":"Setup Scripts","href":"/docs/scripts/setup/page"}]}
    >
        ...
        <Card className="mb-16 border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
          <CardHeader className="text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Comprehensive documentation for Setup Scripts is being prepared.
            </p>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3 text-center">
              <div>
                ...
                <h3 className="text-lg font-semibold mb-2">Setup Scripts</h3>
                <p className="text-muted-foreground">Project setup and configuration scripts</p>
              </div>
              <div>
