...
export default function SentryPage() {
  return (
    <DocsLayout
      title="Sentry - Error tracking and monitoring"
      breadcrumbs={[{"title":"Home","href":"/"},{"title":"Documentation","href":"/docs"},{"title":"Sentry","href":"/docs/sentry"},{"title":"Sentry","href":"/docs/services/sentry/page"}]}
    >
        ...
        <Card className="mb-16 border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
          <CardHeader className="text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Comprehensive documentation for Sentry is being prepared.
            </p>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3 text-center">
              <div>
                ...
                <p className="text-muted-foreground">Error tracking and monitoring</p>
              </div>
              <div>
