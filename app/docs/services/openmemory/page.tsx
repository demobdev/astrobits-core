...
export default function OpenMemoryPage() {
  return (
    <DocsLayout
      title="OpenMemory - Memory management and context"
      breadcrumbs={[{"title":"Home","href":"/"},{"title":"Documentation","href":"/docs"},{"title":"Openmemory","href":"/docs/openmemory"},{"title":"OpenMemory","href":"/docs/services/openmemory/page"}]}
    >
        ...
        <Card className="mb-16 border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
          <CardHeader className="text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Comprehensive documentation for OpenMemory is being prepared.
            </p>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3 text-center">
              <div>
                ...
                <h3 className="text-lg font-semibold mb-2">OpenMemory</h3>
                <p className="text-muted-foreground">Memory management and context</p>
              </div>
              <div>
