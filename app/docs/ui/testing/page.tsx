...
export default function ComponentTestingPage() {
  return (
    <DocsLayout
      title="Component Testing - Test your UI components"
      breadcrumbs={[{"title":"Home","href":"/"},{"title":"Documentation","href":"/docs"},{"title":"Testing","href":"/docs/testing"},{"title":"Component Testing","href":"/docs/ui/testing/page"}]}
    >
          ...
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3 text-center">
              <div>
                ...
                <p className="text-muted-foreground">Test your UI components</p>
              </div>
              <div>
