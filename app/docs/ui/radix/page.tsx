...
export default function RadixUIPage() {
  return (
    <DocsLayout
      title="Radix UI - Unstyled, accessible UI primitives"
      breadcrumbs={[{"title":"Home","href":"/"},{"title":"Documentation","href":"/docs"},{"title":"Radix","href":"/docs/radix"},{"title":"Radix UI","href":"/docs/ui/radix/page"}]}
    >
        ...
        <Card className="mb-16 border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
          <CardHeader className="text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Comprehensive documentation for Radix UI is being prepared.
            </p>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3 text-center">
              <div>
                ...
                <h3 className="text-lg font-semibold mb-2">Radix UI</h3>
                <p className="text-muted-foreground">Unstyled, accessible UI primitives</p>
              </div>
              <div>
