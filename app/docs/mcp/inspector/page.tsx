...
import { Search, Clock, FileText, Settings } from "lucide-react"

export default function MCPInspectorGuidePage() {
  return (
    <DocsLayout
      title="MCP Inspector Guide - Debug and inspect MCP connections"
      breadcrumbs={[{"title":"Home","href":"/"},{"title":"Documentation","href":"/docs"},{"title":"Inspector","href":"/docs/inspector"},{"title":"MCP Inspector Guide","href":"/docs/mcp/inspector/page"}]}
    >
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl sm:text-2xl mb-8 text-muted-foreground max-w-4xl mx-auto">
            Debug and inspect MCP connections
          </p>
        </div>
        ...
        <Card className="mb-16 border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
          <CardHeader className="text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Comprehensive documentation for MCP Inspector Guide is being prepared.
            </p>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3 text-center">
              <div>
                ...
                <h3 className="text-lg font-semibold mb-2">MCP Inspector Guide</h3>
                <p className="text-muted-foreground">Debug and inspect MCP connections</p>
              </div>
              <div>
